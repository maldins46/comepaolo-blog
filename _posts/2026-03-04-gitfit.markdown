...
categories: projects
tags: fitness automation strava github-actions python self-improvement
image: /assets/article_images/2026-03-04-gitfit/cover-image.jpg
image2: /assets/article_images/2026-03-04-gitfit/cover-image.jpg
permalink: /projects/gitfit/
---
...
![GitHub contribution graph showing mostly empty weeks]({{ site.baseurl }}/assets/article_images/2026-03-04-gitfit/contributions-before.png "My contribution graph before GitFit: lots of empty squares during my most active fitness months")
...
![Architecture diagram showing Strava API to GitHub via Actions]({{ site.baseurl }}/assets/article_images/2026-03-04-gitfit/architecture.png "How GitFit works: public repo runs the sync code, commits push to a private repo")
...
![Example Strava activity that generated commits]({{ site.baseurl }}/assets/article_images/2026-03-04-gitfit/activity-example.png "An evening run from February 2026, now immortalized as green squares")
...
**Did this change my life? No.** I'm still the same person, doing the same workouts. The runs happened whether GitHub knew about them or not.

But here's what it *did* change: **how I think about what counts as progress.**

For years, I measured my growth almost exclusively through code. Ship a feature? Growth. Learn a new framework? Growth. Everything else—fitness, relationships, experiences—somehow felt less... official. Less trackable. Less real.

GitFit is my quiet rebellion against that mindset. It's me saying: **taking care of myself counts.** Showing up for a run at 6 AM counts. Choosing to ride my bike instead of doom-scrolling counts.

And yeah, seeing those activities reflected on my GitHub profile? That tiny bit of visible validation actually helps me show up again the next day.
...
*Now if you'll excuse me, I have a 5K to run. Those green squares won't earn themselves.*
